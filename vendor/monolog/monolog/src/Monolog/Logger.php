 ...
 */
namespace QAAnalyticsVendor\Monolog;

use QAAnalyticsVendor\Monolog\Handler\HandlerInterface;
use QAAnalyticsVendor\Monolog\Handler\StreamHandler;
use QAAnalyticsVendor\Psr\Log\LoggerInterface;
use QAAnalyticsVendor\Psr\Log\InvalidArgumentException;
use Exception;
/**
 * Monolog log channel
 *
