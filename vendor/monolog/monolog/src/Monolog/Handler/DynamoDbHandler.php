...
use QAAnalyticsVendor\Aws\Sdk;
use QAAnalyticsVendor\Aws\DynamoDb\DynamoDbClient;
use QAAnalyticsVendor\Aws\DynamoDb\Marshaler;
use QAAnalyticsVendor\Monolog\Formatter\ScalarFormatter;
