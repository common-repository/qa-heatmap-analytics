...
use QAAnalyticsVendor\Gelf\IMessagePublisher;
use QAAnalyticsVendor\Gelf\PublisherInterface;
use QAAnalyticsVendor\Gelf\Publisher;
use InvalidArgumentException;
use QAAnalyticsVendor\Monolog\Logger;
use QAAnalyticsVendor\Monolog\Formatter\GelfMessageFormatter;
/**
