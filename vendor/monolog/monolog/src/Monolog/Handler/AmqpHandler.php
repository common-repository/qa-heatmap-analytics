...
use QAAnalyticsVendor\Monolog\Formatter\JsonFormatter;
use QAAnalyticsVendor\PhpAmqpLib\Message\AMQPMessage;
use QAAnalyticsVendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
