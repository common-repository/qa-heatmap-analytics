...
use QAAnalyticsVendor\PhpConsole\Connector;
use QAAnalyticsVendor\PhpConsole\Handler;
use QAAnalyticsVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('QAAnalyticsVendor\\PhpConsole\\Connector')) {
