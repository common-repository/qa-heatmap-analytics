...
use QAAnalyticsVendor\Monolog\Formatter\LineFormatter;
use QAAnalyticsVendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\QAAnalyticsVendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, $bubble = \true)
    {
    ...
    {
        $message = null;
        if ($this->messageTemplate instanceof \QAAnalyticsVendor\Swift_Message) {
