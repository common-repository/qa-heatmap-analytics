...
use QAAnalyticsVendor\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use QAAnalyticsVendor\GuzzleHttp\Promise\Promise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('QAAnalyticsVendor\\GuzzleHttp\\Promise\\Promise')) {
