...
use QAAnalyticsVendor\Google\Auth\Iam;
use QAAnalyticsVendor\Google\Auth\ProjectIdProviderInterface;
use QAAnalyticsVendor\Google\Auth\SignBlobInterface;
use QAAnalyticsVendor\GuzzleHttp\Exception\ClientException;
use QAAnalyticsVendor\GuzzleHttp\Exception\ConnectException;
use QAAnalyticsVendor\GuzzleHttp\Exception\RequestException;
use QAAnalyticsVendor\GuzzleHttp\Exception\ServerException;
