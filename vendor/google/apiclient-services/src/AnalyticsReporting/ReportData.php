...
class ReportData extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(ReportData::class, 'QAAnalyticsVendor\\Google_Service_AnalyticsReporting_ReportData');
