...
class SegmentMetricFilter extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SegmentMetricFilter::class, 'QAAnalyticsVendor\\Google_Service_AnalyticsReporting_SegmentMetricFilter');
