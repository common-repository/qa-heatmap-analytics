...
class GetReportsResponse extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(GetReportsResponse::class, 'QAAnalyticsVendor\\Google_Service_AnalyticsReporting_GetReportsResponse');
