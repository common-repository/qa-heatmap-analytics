...
class CohortGroup extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(CohortGroup::class, 'QAAnalyticsVendor\\Google_Service_AnalyticsReporting_CohortGroup');
