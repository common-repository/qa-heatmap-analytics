...
class ReportRequest extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(ReportRequest::class, 'QAAnalyticsVendor\\Google_Service_AnalyticsReporting_ReportRequest');
