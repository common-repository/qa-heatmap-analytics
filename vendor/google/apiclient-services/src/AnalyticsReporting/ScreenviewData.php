...
class ScreenviewData extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ScreenviewData::class, 'QAAnalyticsVendor\\Google_Service_AnalyticsReporting_ScreenviewData');
