...
class UserActivitySession extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(UserActivitySession::class, 'QAAnalyticsVendor\\Google_Service_AnalyticsReporting_UserActivitySession');
