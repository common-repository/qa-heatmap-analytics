...
class RemarketingAudience extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(RemarketingAudience::class, 'QAAnalyticsVendor\\Google_Service_Analytics_RemarketingAudience');
