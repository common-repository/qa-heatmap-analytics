...
class FilterExpression extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(FilterExpression::class, 'QAAnalyticsVendor\\Google_Service_Analytics_FilterExpression');
