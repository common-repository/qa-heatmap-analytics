...
class AccountSummary extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(AccountSummary::class, 'QAAnalyticsVendor\\Google_Service_Analytics_AccountSummary');
