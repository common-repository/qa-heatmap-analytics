...
class HashClientIdResponse extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(HashClientIdResponse::class, 'QAAnalyticsVendor\\Google_Service_Analytics_HashClientIdResponse');
