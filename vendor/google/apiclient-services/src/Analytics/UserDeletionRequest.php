...
class UserDeletionRequest extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UserDeletionRequest::class, 'QAAnalyticsVendor\\Google_Service_Analytics_UserDeletionRequest');
