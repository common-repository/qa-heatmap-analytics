...
class LinkedForeignAccount extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(LinkedForeignAccount::class, 'QAAnalyticsVendor\\Google_Service_Analytics_LinkedForeignAccount');
