...
class UnsampledReport extends \QAAnalyticsVendor\Google\Model
{
...
\class_alias(UnsampledReport::class, 'QAAnalyticsVendor\\Google_Service_Analytics_UnsampledReport');
