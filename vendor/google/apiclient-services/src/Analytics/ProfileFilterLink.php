...
class ProfileFilterLink extends \QAAnalyticsVendor\Google\Model
{
...
\class_alias(ProfileFilterLink::class, 'QAAnalyticsVendor\\Google_Service_Analytics_ProfileFilterLink');
