...
class EntityUserLinkEntity extends \QAAnalyticsVendor\Google\Model
{
...
\class_alias(EntityUserLinkEntity::class, 'QAAnalyticsVendor\\Google_Service_Analytics_EntityUserLinkEntity');
