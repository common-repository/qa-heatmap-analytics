...
class EntityAdWordsLink extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(EntityAdWordsLink::class, 'QAAnalyticsVendor\\Google_Service_Analytics_EntityAdWordsLink');
