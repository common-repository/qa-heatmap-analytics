...
class FilterAdvancedDetails extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(FilterAdvancedDetails::class, 'QAAnalyticsVendor\\Google_Service_Analytics_FilterAdvancedDetails');
