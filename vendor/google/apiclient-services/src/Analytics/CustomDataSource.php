...
class CustomDataSource extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(CustomDataSource::class, 'QAAnalyticsVendor\\Google_Service_Analytics_CustomDataSource');
