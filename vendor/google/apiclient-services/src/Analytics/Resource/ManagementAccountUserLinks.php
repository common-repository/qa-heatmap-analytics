 ...
 *  </code>
 */
class ManagementAccountUserLinks extends \QAAnalyticsVendor\Google\Service\Resource
{
    /**
...
\class_alias(ManagementAccountUserLinks::class, 'QAAnalyticsVendor\\Google_Service_Analytics_Resource_ManagementAccountUserLinks');
