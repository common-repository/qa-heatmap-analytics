 ...
 *  </code>
 */
class ManagementProfileUserLinks extends \QAAnalyticsVendor\Google\Service\Resource
{
    /**
...
\class_alias(ManagementProfileUserLinks::class, 'QAAnalyticsVendor\\Google_Service_Analytics_Resource_ManagementProfileUserLinks');
