...
class AccountTreeRequest extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AccountTreeRequest::class, 'QAAnalyticsVendor\\Google_Service_Analytics_AccountTreeRequest');
