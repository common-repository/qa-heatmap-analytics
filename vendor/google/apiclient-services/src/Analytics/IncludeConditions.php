...
class IncludeConditions extends \QAAnalyticsVendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(IncludeConditions::class, 'QAAnalyticsVendor\\Google_Service_Analytics_IncludeConditions');
