...
class IndexStatusInspectionResult extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(IndexStatusInspectionResult::class, 'QAAnalyticsVendor\\Google_Service_SearchConsole_IndexStatusInspectionResult');
