...
class SearchAnalyticsQueryRequest extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(SearchAnalyticsQueryRequest::class, 'QAAnalyticsVendor\\Google_Service_SearchConsole_SearchAnalyticsQueryRequest');
