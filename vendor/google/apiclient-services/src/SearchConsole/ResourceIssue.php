...
class ResourceIssue extends \QAAnalyticsVendor\Google\Model
{
...
\class_alias(ResourceIssue::class, 'QAAnalyticsVendor\\Google_Service_SearchConsole_ResourceIssue');
