...
class AmpInspectionResult extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(AmpInspectionResult::class, 'QAAnalyticsVendor\\Google_Service_SearchConsole_AmpInspectionResult');
