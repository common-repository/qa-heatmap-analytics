...
class RunMobileFriendlyTestResponse extends \QAAnalyticsVendor\Google\Collection
{
...
\class_alias(RunMobileFriendlyTestResponse::class, 'QAAnalyticsVendor\\Google_Service_SearchConsole_RunMobileFriendlyTestResponse');
