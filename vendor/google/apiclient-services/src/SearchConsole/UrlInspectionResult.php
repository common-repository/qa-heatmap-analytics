...
class UrlInspectionResult extends \QAAnalyticsVendor\Google\Model
{
...
\class_alias(UrlInspectionResult::class, 'QAAnalyticsVendor\\Google_Service_SearchConsole_UrlInspectionResult');
