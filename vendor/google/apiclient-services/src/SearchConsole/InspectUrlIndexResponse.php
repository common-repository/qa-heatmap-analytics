...
class InspectUrlIndexResponse extends \QAAnalyticsVendor\Google\Model
{
...
\class_alias(InspectUrlIndexResponse::class, 'QAAnalyticsVendor\\Google_Service_SearchConsole_InspectUrlIndexResponse');
