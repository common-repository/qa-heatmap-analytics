...
namespace QAAnalyticsVendor\Psr\Log\Test;

use QAAnalyticsVendor\Psr\Log\LoggerInterface;
use QAAnalyticsVendor\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('QAAnalyticsVendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('QAAnalyticsVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('QAAnalyticsVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
