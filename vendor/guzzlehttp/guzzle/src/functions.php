...
use QAAnalyticsVendor\GuzzleHttp\Handler\CurlHandler;
use QAAnalyticsVendor\GuzzleHttp\Handler\CurlMultiHandler;
use QAAnalyticsVendor\GuzzleHttp\Handler\Proxy;
use QAAnalyticsVendor\GuzzleHttp\Handler\StreamHandler;
/**
...
function uri_template($template, array $variables)
{
    if (\extension_loaded('uri_template')) {
        ...
        return \QAAnalyticsVendor\uri_template($template, $variables);
