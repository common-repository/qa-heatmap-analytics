...
use QAAnalyticsVendor\GuzzleHttp\Cookie\CookieJarInterface;
        ...
        return function (callable $handler) {
            return function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('QAAnalyticsVendor\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
