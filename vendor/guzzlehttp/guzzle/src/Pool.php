...
use QAAnalyticsVendor\GuzzleHttp\Promise\EachPromise;
use QAAnalyticsVendor\GuzzleHttp\Promise\PromiseInterface;
use QAAnalyticsVendor\GuzzleHttp\Promise\PromisorInterface;
...
class Pool implements PromisorInterface
{
    ...
    public function __construct(ClientInterface $client, $requests, array $config = [])
    {
        ...
        $iterable = \QAAnalyticsVendor\GuzzleHttp\Promise\iter_for($requests);
